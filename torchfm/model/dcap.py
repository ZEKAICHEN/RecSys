...
class DeepCrossAttentionalProductNetwork(torch.nn.Module):
    ...
    def __init__(self, field_dims, embed_dim, num_heads, num_layers, mlp_dims, dropout):
        super().__init__()
        num_fields = len(field_dims)
        self.cap = CrossAttentionalProductNetwork(num_fields, embed_dim, num_heads, num_layers, dropout)
